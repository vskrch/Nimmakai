...
_AUTO_ALIAS: dict[str, AutoTier] = {
    # Potato
    "auto": "balanced",
    "potato/auto": "balanced",
    "potato/auto-coding": "coding",
    "potato/best": "coding",
    "potato/coding": "coding",
    "best": "coding",
    "coding": "coding",
    "auto-coding": "coding",
    "potato/auto-fast": "fast",
    "auto-fast": "fast",
    "potato/auto-cheap": "efficient",
    ...
    "claude-opus-5": "coding",
    "claude-opus-5-2026": "coding",
    ...
    "opencode-go": "coding",
    "opencode/go": "coding",
    "opencode-go/grok-4.5": "frontier",
    "opencode-go/glm-5.2": "coding",
    "opencode-go/glm-5.1": "coding",
    "opencode-go/kimi-k3": "reasoning",
    "opencode-go/kimi-k2.7-code": "coding",
    "opencode-go/kimi-k2.6": "coding",
    "opencode-go/deepseek-v4-pro": "reasoning",
    "opencode-go/deepseek-v4-flash": "fast",
    "opencode-go/mimo-v2.5": "coding",
    "opencode-go/mimo-v2.5-pro": "coding",
    "opencode-go/minimax-m3": "frontier",
    "opencode-go/minimax-m2.7": "coding",
    "opencode-go/minimax-m2.5": "fast",
    "opencode-go/qwen3.7-max": "frontier",
    "opencode-go/qwen3.7-plus": "coding",
    "opencode-go/qwen3.6-plus": "coding",
    "opencode-go/hy3": "fast",
    "cline/auto": "coding",
    "cline/coding": "coding",
}
